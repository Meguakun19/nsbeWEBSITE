...
class CustomUser(AbstractUser):
    ...
    username = models.CharField(verbose_name='Name',max_length=45, unique=True, blank=False)
    email_address = models.EmailField(verbose_name='Email Address', max_length=255, unique=True, null=True, blank=False)
    ...
    grade_point_average = models.CharField(verbose_name='GPA',max_length=4, default=0.0, blank=False)
    FRESHMAN = 'FR'
    SOPHOMORE = 'SO'
    JUNIOR = 'JR'
    SENIOR = 'SR'
